...
def document_excel(request, reception_id):
    ...
    for reception in receptions:
        ...
        if medical_receipt == True:
            ...
            ws['B' + str(22)] = 'Tổng tiền/Total '
            ws['B' + str(22)].font = Font(bold = True)
            ws['D' + str(22)] = f"{sub_total:,}"

            ws['B' + str(23)] = 'Giảm trừ/Discount'
            ws['B' + str(23)].font = Font(bold = True)
            ws['D' + str(23)] = f"{discount:,}"
            ...
            ws['B' + str(26)] = 'Amount due / Thành tiền '
            ws['B' + str(26)].font = Font(bold = True)
            ws['D' + str(26)] = f"{total:,}" 

            ws['C' + str(29)] = 'Ngày/Date: ' + reception.recorded_date.strftime('%d/%m/%Y') 
            ws['C' + str(29)].font = Font(bold = True)                   
        ...
        if medicine_receipt == True:            
            ...
            ws['B' + str(48)] = 'Tổng trước thuế/Sub Total without VAT'
            ...
            ws['B' + str(50)] = 'Tổng tiền/Total'
            ws['B' + str(50)].font = Font(bold = True)
            ws['G' + str(50)] = f"{int(total):,}"
