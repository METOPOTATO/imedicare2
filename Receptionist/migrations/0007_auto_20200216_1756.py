# Generated by Django 2.1.15 on 2020-02-16 17:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Receptionist', '0006_new_patient_question'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cure_yn', models.CharField(choices=[('1', '예'), ('0', '아니오')], max_length=1)),
                ('cure_phy_yn', models.CharField(choices=[('1', '예'), ('0', '아니오')], max_length=1)),
                ('cure_phy_cnt', models.CharField(max_length=10, null=True)),
                ('cure_inject_yn', models.CharField(choices=[('1', '예'), ('0', '아니오')], max_length=1)),
                ('cure_inject_cnt', models.CharField(max_length=10, null=True)),
                ('cure_medi_yn', models.CharField(choices=[('1', '예'), ('0', '아니오')], max_length=1)),
                ('cure_medi_cnt', models.CharField(max_length=10, null=True)),
                ('cure_needle_yn', models.CharField(choices=[('1', '예'), ('0', '아니오')], max_length=1)),
                ('cure_needle_cnt', models.CharField(max_length=10, null=True)),
                ('pain_level', models.CharField(max_length=2, null=True)),
                ('surgery_yn', models.CharField(choices=[('1', '예'), ('0', '아니오')], max_length=1)),
                ...
                ('side_effect_yn', models.CharField(choices=[('1', '예'), ('0', '아니오')], max_length=1)),
                ('pregnant_yn', models.CharField(choices=[('0', '없음'), ('1', 'CD'), ('2', '필름')], max_length=18, null=True)),
                ('visit_motiv', models.CharField(max_length=50, null=True)),
                ('cd_film_yn', models.CharField(choices=[('1', '없음'), ('2', 'CD'), ('3', '필름')], max_length=1, null=True)),
                ('insurance_yn', models.CharField(max_length=1, null=True)),
